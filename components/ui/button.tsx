    ...
    return (
      <button
        className={cn(
          ...
          // Variants
          variant === "primary" && "bg-[#1A4BFF] text-white border-2 border-[#1A4BFF] hover:-translate-x-[2px] hover:-translate-y-[2px] hover:shadow-hard-sm active:translate-x-0 active:translate-y-0 shadow-none",
